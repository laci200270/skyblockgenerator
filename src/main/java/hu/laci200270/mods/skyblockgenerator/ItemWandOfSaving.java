...
public class ItemWandOfSaving extends Item {
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_,
		...
		if((pos1!=null)&&(pos2!=null)){
			...
			NBTTagCompound compond=DATAFileFormatHelper.saveWorldRegionToNBT(p_77659_2_, pos1, pos2);
			try {
			FileOutputStream fos=new FileOutputStream(new File(SkyBlockGeneratorModFile.configFolder, "structure.dat"));

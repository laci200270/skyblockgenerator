...
public class SkyBlockChunkGenerator implements IChunkProvider {
	...
	public SkyBlockChunkGenerator(World p_i2004_1_, long p_i2004_2_,
		...
		for (int k = 0; k < this.cachedBlockIDs.length; ++k) {
			...
			if (block != null) {
				...
				ExtendedBlockStorage extendedblockstorage = chunk
						.getBlockStorageArray()[l];

				if (extendedblockstorage == null) {
					extendedblockstorage = new ExtendedBlockStorage(k,
				...
				for (int i1 = 0; i1 < 16; ++i1) {
					for (int j1 = 0; j1 < 16; ++j1) {
						extendedblockstorage.func_150818_a(i1, k & 15, j1,
								block);
						extendedblockstorage.setExtBlockMetadata(i1, k & 15,
								j1, this.cachedBlockMetadata[k]);
					}
				}
			}
		}
